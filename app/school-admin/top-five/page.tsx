        ...
        <div className="rounded-[2em] flex flex-col gap-[2em] pb-[2em]">
          ...
          <div className="flex flex-col w-full">
            <table>
              <thead>
                <tr>
                  <th className="text-center pb-4 px-2 text-[#bbb]">{""}</th>
                  <th className="text-center pb-4 px-2 text-[#bbb]">{""}</th>
                  <th className="text-center pb-4 px-2 text-[#bbb]">Class</th>
                  <th className="text-center pb-4 px-2 text-[#bbb]">Points</th>
                </tr>
              </thead>
              <tbody>
                <tr className="bg-white shadow-lg shadow-gray-500/.5 mt-[20px]">
                  <td>
                    <div className="bg-white p-[20px]">1st</div>
                  </td>
                  <td>
                ...
                <tr className="bg-white shadow-lg shadow-gray-500/.5 mt-[20px]">
                  <td>
                    <div className="bg-white p-[20px]">2nd</div>
                  </td>
                  <td>
                    <div className="bg-white p-[20px] flex items-center">
                      <Image
                ...
                <tr className="bg-white shadow-lg shadow-gray-500/.5 mt-[20px]">
                  <td>
                    <div className="bg-white p-[20px]">3rd</div>
                  </td>
                  <td>
                    <div className="bg-white p-[20px] flex items-center">
                      <Image
                ...
                <tr className="bg-white shadow-lg shadow-gray-500/.5 mt-[20px]">
                  <td>
                    <div className="bg-white p-[20px]">4th</div>
                  </td>
                  <td>
                    <div className="bg-white p-[20px] flex items-center">
                      <Image
                ...
                <tr className="bg-white shadow-lg shadow-gray-500/.5 mt-[20px]">
                  <td>
                    <div className="bg-white p-[20px]">5th</div>
                  </td>
                  <td>
                    <div className="bg-white p-[20px] flex items-center">
                      <Image
