...
export default function Page() {
  ...
  const { setValue, register, handleSubmit, formState: { errors, isSubmitting } } = useForm<Subject>({
  ...
  return (
    ...
    >
      <div className="bg-white p-8 rounded-lg shadow-md max-w-lg mx-auto mt-10">
        <h2 className="text-2xl font-semibold mb-6 text-gray-800 text-center">Create a New Subject</h2>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="flex flex-col gap-4">
            ...
            <Button type="submit" className="w-full flex items-center justify-center bg-brand-sea-green hover:bg-brand-pink transition duration-300 ease-in-out">
