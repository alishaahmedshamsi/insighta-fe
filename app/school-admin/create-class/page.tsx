		...
		>
			<div className="flex justify-center min-h-64  ">
				<div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
					<h2 className="text-2xl font-semibold mb-6 text-gray-800 text-center">Create a New Class</h2>
					<form onSubmit={handleFormSubmit}>
						<div className="mb-4">
							<label htmlFor="classInput" className="block text-sm font-medium text-gray-700">
								Class
							</label>
							<input
								id="classInput"
						...
						<div className="flex justify-end">
							<Button size={"lg"} type="submit" className="bg-brand-sea-green hover:bg-brand-pink">
								Create
							</Button>
						</div>
					</form>
